  ...
  $.fn.toc = function(options) {
    ...
    .each(function(_, header) {
      ...
      if (this_level === level) {// same level as before; same indenting
        html += "<li style=\"padding-bottom:0px;\" class=\"toc-item toc-level-" + this_level + "\">";
        ...
        html += "<li style=\"padding-bottom:0px;\" class='toc-item toc-level-" + this_level + "'><a class=\"jumper\" href='#" + fixedEncodeURIComponent(header.id) + "'>";
        html += "<span class='toc-text'>" + header.innerHTML + "</span>";
        html += "</a>";
      }
