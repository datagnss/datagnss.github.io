...
| Rover mode       | 5Hz, GGA/GSA/RMC/VTG/ZDA/GST/GSV | [Config Rover mode,5Hz](../assets/config/config_rover_5hz.cmd)  [Config Rover mode,all 5Hz](../assets/config/config_rover_5hz_all.cmd) |
